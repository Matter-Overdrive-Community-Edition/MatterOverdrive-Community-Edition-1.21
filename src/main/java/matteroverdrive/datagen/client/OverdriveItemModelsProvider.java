...
public class OverdriveItemModelsProvider extends ItemModelProvider {
	...
	public static final int SECURITY_PROTOCOL_COUNT = 4;
		...
		public OverdriveItemModelsProvider(PackOutput output, ExistingFileHelper existingFileHelper, String modID) {
			super(output, modID, existingFileHelper);
			this.modID = modID;
		}

		public OverdriveItemModelsProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
