...
public class BarrelUpgrade extends OverdriveItem {

	public UpgradeBarrel type;

	public BarrelUpgrade(UpgradeBarrel type) {
	...
	public enum UpgradeBarrel implements IBulkRegistryObject {
		...
		private UpgradeBarrel(double speedBonus, double matterStorageBonus, double matterUsageBonus,
