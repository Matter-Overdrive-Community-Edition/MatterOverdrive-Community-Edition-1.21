...
public class ColorUpgrade extends OverdriveItem {
	...
	public enum UpgradeColor implements IBulkRegistryObject {
		...
		private UpgradeColor(double speedBonus, double matterStorageBonus, double matterUsageBonus,
